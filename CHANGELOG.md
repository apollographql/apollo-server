...
- core: make hash of Engine API key available to plugins via `GraphQLServiceContext.engine.apiKeyHash` [PR#2685](https://github.com/apollographql/apollo-server/pull/2685)
