...
- Core: Allow context to be passed to all GraphQLExtension methods. [PR #1547](https://github.com/apollographql/apollo-server/pull/1547),[PR #1653](https://github.com/apollographql/apollo-server/pull/1653)
