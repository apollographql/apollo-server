...
- `apollo-server-core`: Update GraphQL Playground to latest version to remove a small, rogue curly-brace appearing in the top-right corner of the interface. [PR #3702](https://github.com/apollographql/apollo-server/pull/3702) [Playground PR](https://github.com/apollographql/graphql-playground/pull/21)
