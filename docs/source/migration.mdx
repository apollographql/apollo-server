...
>
> [Learn more about deprecation and end-of-life.](/apollo-server/other-versions)

Apollo Server 3 is deprecated, and we [**strongly recommend upgrading to Apollo Server 4**](/apollo-server/migration/). If you are currently using Apollo Server 2, we recommend first upgrading to Apollo Server 3 using this guide. Afterwards, you can continue upgrading from [Apollo Server 3 to 4](/apollo-server/migration/).
