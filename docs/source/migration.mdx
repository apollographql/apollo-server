...
> 📣 **Apollo Server 4 is now generally available!** [Learn about release stages.](/resources/product-launch-stages/#general-availability)
...
* Support for both ECMAScript (ESM) and CommonJS (CJS) modules.
* Experimental support for [incremental delivery](./workflow/requests#incremental-delivery-experimental) in combination with a pre-release of `graphql-js`.
