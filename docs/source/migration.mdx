...
> For a list of all breaking changes, see the [changelog](https://github.com/apollographql/apollo-server/blob/main/packages/server/CHANGELOG.md) ([temporary location](https://github.com/apollographql/apollo-server/blob/version-4/packages/server/CHANGELOG.md)).
