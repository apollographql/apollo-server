...
interface ContextValue { // highlight-line
  token: string; // highlight-line
  dataSources: { // highlight-line
    moviesAPI: MoviesAPI; // highlight-line
  }; // highlight-line
} // highlight-line
