...
If your resolvers are in multiple files, you can pull out the corresponding generated types for the resolvers in that file. For example, below, we import the generated types in the separate files we have for our queries and mutations:  
