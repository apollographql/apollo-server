...
<table>
  <thead>
    <tr>
      <th>Client Name</th>
      <th>Minimum version required for graphql-ws</th>
      <th>To use graphql-ws</th>
      <th>To use subscriptions-transport-ws (OLDER)</th>
    </tr>
  </thead>
...
[Apollo Client Web](https://www.apollographql.com/docs/react/)
...
Use [`GraphQLWsLink`](https://www.apollographql.com/docs/react/api/link/apollo-link-subscriptions/)
...
[Apollo iOS](https://www.apollographql.com/docs/studio/explorer/additional-features/#subscription-support)
...
[`graphql_transport_ws`](https://www.apollographql.com/docs/ios/api/ApolloWebSocket/enums/WebSocket.WSProtocol/#graphql_transport_ws) (Really, we promise!)
...
[Apollo Kotlin](https://www.apollographql.com/docs/studio/explorer/additional-features/#subscription-support)
...
[`GraphQLWsProtocol`](https://www.apollographql.com/docs/kotlin/essentials/subscriptions/#customizing-your-websocket-protocol)
...
* Update to [Apollo Client 3.5.10 or later](https://www.apollographql.com/docs/react/data/subscriptions/#choice-of-subscription-protocol)
...
* Update to [Apollo iOS 0.51.0 or later](https://github.com/apollographql/apollo-ios) and [customize your WebSocket protocol](https://www.apollographql.com/docs/ios/subscriptions/#graphql-over-websocket-protocols) -->
