...
Use the [<code>executionOptions</code>](../api/apollo-server#executionoptions) field to configure how many variable coercion errors are allowed before execution terminates.
