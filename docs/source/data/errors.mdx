...
Use the [<code>executionOptions</code> field](../api/apollo-server#executionoptions) to configure how many variable coercion errors are allowed before execution terminates.
