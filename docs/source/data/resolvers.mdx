...
> **Apollo Server 3 has been released.** Most applications require few or no changes to upgrade. For details, see the [migration guide](../migration/).
>
> You can also [switch to the v2 docs](https://www.apollographql.com/docs/apollo-server/v2).
...
If you don't define a resolver for a particular schema field, Apollo Server defines a default resolver for it ([see the source](https://github.com/graphql/graphql-js/blob/main/src/execution/execute.ts#L999-L1015)).
