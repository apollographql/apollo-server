...
<!-- Do we want this article to just cover REST? Or do we also want people to use the [`DataSource` abstract class] to make their own data sources? Essentially, do we want folks to import and use the Data source classes? That'll significantly change the narrative.

We do want this to mainly be REST datasource

What this article should cover:
1. REST Datasource including examples
