---
title: Apollo Server 4 (Release Candidate)
---

> 📣 **Apollo Server 4 is currently available as a [Release Candidate](/resources/product-launch-stages).**
>
...
* The GraphQL server for a [subgraph](/federation/building-supergraphs/subgraphs-apollo-server) in a federated supergraph
