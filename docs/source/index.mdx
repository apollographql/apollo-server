...
>
> Apollo Server 4 introduces many across-the-board changes,  and we are working on updating our docs to reflect these changes. We have temporarily removed most of the documentation from this version and will add pieces back as we ensure they are up to date for Apollo Server 4. In the meantime, you can reference the [Apollo Server 3 docs](/apollo-server/v3/) for more in-depth information on Apollo Server's features.
>
> Check out the migration guide to [see what's new](/migration/) in Apollo Server 4!
