...
>
> Apollo Server 4 introduces many across-the-board changes,  and we are working on updating our docs to reflect these changes. In the meantime, you can reference the [Apollo Server 3 docs](/apollo-server/v3/) for more in-depth information on Apollo Server's features.
>
