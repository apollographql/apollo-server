...
<!-- TODO(AS4) remove this when RESTDataSource is up -->
> The Apollo Server 4 alpha doesn't currently support using [`RESTDataSource`](./migration#datasources), a class commonly used to fetch data from a database or a REST API. 
