...
> This tutorial uses Apollo Server's standalone web server. If you'd like to integrate Apollo Server with your favorite web framework such as Express, you can read about [web framework integrations](./integrations/integration-index).
