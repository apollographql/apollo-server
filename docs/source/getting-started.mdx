...
this information to Apollo Server when we initialize it. (We also want to enable
[CSRF prevention](./security/cors#preventing-cross-site-request-forgery-csrf),
an important security feature that is only disabled by default for reasons of
