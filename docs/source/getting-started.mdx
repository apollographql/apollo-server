...
> **Apollo Server 3 is generally available.** It is _not yet_ the default version installed with `npm install`. Check out the [Apollo Server 3 docs](https://www.apollographql.com/docs/apollo-server/v3/) and [migration guide](https://www.apollographql.com/docs/apollo-server/v3/migration/).
