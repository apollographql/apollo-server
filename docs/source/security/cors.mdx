...
The example above enables CORS requests from two origins `http://localhost:3000` and `https://studio.apollographql.com` (the origin for [Apollo Studio Explorer](https://www.apollographql.com/docs/studio/explorer/explorer/)).
