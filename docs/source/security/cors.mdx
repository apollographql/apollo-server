...
The example above enables CORS requests from `http://localhost:3000`, along with `https://studio.apollographql.com` (the origin for [Apollo Studio Explorer](https://www.apollographql.com/docs/studio/explorer/explorer/)).
