...
Apollo Federation also supports a free [managed mode with Apollo Studio](https://www.apollographql.com/docs/studio/managed-federation/overview/), which enables you to add, remove, and refactor your implementing services without requiring any downtime for your production graph.
