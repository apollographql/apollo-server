...
> If you run your gateway in a serverless environment (such as AWS Lambda), we recommend setting your function's timeout to at least 10 seconds to prevent unexpected errors.
