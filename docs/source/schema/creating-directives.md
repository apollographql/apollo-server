...
Before learning how to implement schema directives, [this section](/defining-a-schema/directives/) will provide the necessary background on schema directives and their use.
