...
End-of-life versions will remain available in the npm registry. They can still be installed and used in your projects, but Apollo does not guarantee any further support for them nor does Apollo recommend their use.
