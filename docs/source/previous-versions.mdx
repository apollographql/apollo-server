...
End-of-life versions will remain available in the npm registry. They can still be installed and used in your projects, but Apollo does not guarantee any further support for them nor does Apollo recommend their use. Apollo makes no guarantee that Apollo Studio or GraphOS features will continue to work as expected in tandem with packages that are beyond their end-of-life date.
