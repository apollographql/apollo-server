...
When you consider your app to be production-ready, you should remember to edit it to remove the `NODE_APP` environment variable you set at the beginning. Among other things, this will change its landing page to be more discreet, and will mask error details from the end user.
