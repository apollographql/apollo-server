...
We created this tutorial using a Linux environment. Some commands may differ if you use a Windows environment; [please refer to the Azure documentation for more details](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli-windows?tabs=azure-cli).
