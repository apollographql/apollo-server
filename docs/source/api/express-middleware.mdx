...
> ⚠️ To ensure your server gracefully shuts down, we recommend using the [`ApolloServerPluginDrainHttpServer`](../api/plugin/drain-http-server) plugin. [See below for an example](#example).
