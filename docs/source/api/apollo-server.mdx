...
Note: This option works with [<code>status400ForVariableCoercionErrors</code>](#status400forvariablecoercionerrors) to return appropriate HTTP status codes for variable coercion errors.
