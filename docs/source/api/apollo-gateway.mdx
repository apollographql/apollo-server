...
federated gateway and a single implementing service. You can customize this
communication by defining a `willSendRequest` function that lets you modify each
request's structure before it's sent.
