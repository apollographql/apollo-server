...
The `context` function should return an object that all your server's resolvers share. This enables resolvers to share helpful context values, such as a database connection.
