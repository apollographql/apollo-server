...
| `{ onlyNames: ["apple", "orange"]}`| If you provide an object with this structure, only values of the GraphQL variables with names that appear in the array are sent to Apollo Studio. Use the `transform` function below if you'd like only to include _specific_ values from your GraphQL variables. Case-sensitive. |
| `{ exceptNames: ["apple", "orange"]}`| If you provide an object with this structure, all GraphQL variable values **except** values of the variables with names that appear in the array are sent to Apollo Studio. Use the `transform` function below if you'd like only to exclude _specific_ field values from your GraphQL variables. Case-sensitive. |
