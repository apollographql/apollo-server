---
title: Setting up Apollo Gateway
...
After you set up at least one federation-ready [subgraph](/federation/subgraphs-overview/), you can configure a **graph router** (also known as a gateway) to sit in front of your subgraphs.
...
> The fields of the object passed to your `contextValue` function might differ if you're using a different [Apollo Server integration](../integrations/integration-index).
