...
An object that's passed to every resolver that executes for a particular operation. This enables resolvers to share helpful context.

For details, see [The `context` argument](../../data/resolvers/#the-context-argument).
