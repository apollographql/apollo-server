...
If your plugin needs to read the [`contextValue`] of a request (i.e., `requestContext.contextValue`), then you need to declare your plugin as `ApolloServerPlugin<YourContextType>`
