...
* `apollo-server-core`: Returned relevant error codes when an error is thrown by a context function [#1709](https://github.com/apollographql/apollo-server/issues/1709)
