...
export default class ApolloServerPluginOperationRegistry extends ApolloServerPlugin {
  private agent?: Agent;
  ...
  // Currently, this method is only called by tests to stop the agent.
  public _serverWillStop(): void {
    this.agent && this.agent.stop();
  }
