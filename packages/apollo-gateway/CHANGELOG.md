...
# [0.15.0-alpha.0](/compare/@apollo/gateway@0.14.0...@apollo/gateway@0.15.0-alpha.0) (2020-04-10)

**Note:** Version bump only for package @apollo/gateway
...
- __BREAKING__: Drop support for Node.js 8 and Node.js 10.  This is being done primarily for performance gains which stand to be seen by transpiling to a newer ECMAScript target.
