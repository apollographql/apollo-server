...
- Drop support for `DEBUG=apollo-gateway:` in lieu of new `logger` option.  This existing behavior can be replicated by providing a `logger` that uses `loglevel-debug`. [PR #3896](https://github.com/apollographql/apollo-server/pull/3896)
