...
- Gateway issues health checks to downstream services via `performServiceHealthCheck` configuration option [#3930](https://github.com/apollographql/apollo-server/pull/3930) Note: expected behavior differs between managed and unmanaged federation. See PR for new test cases and documentation.
