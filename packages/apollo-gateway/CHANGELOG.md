...
- Cache constructed / stringified downstream query bodies to address a performance due to `print`ing large `DocumentNode`s [PR #4018](https://github.com/apollographql/apollo-server/pull/4018)
